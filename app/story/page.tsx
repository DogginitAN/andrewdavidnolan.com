  ...
  return (
    <div className="py-8 md:py-12">
      ...
      <section className="mb-16">
        ...
        {/* Blueprint Preview - Clickable */}
        <div className="my-8">
          <button
            onClick={() => setBlueprintOpen(true)}
            className="relative group w-full rounded-xl overflow-hidden border-2 border-neutral-200 dark:border-neutral-800 hover:border-neutral-400 dark:hover:border-neutral-600 transition-all"
          >
            <img 
            ...
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-all flex items-center justify-center">
              <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                <div className="bg-white dark:bg-neutral-900 rounded-lg px-4 py-2 flex items-center gap-2">
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-400 text-center mt-3">
            Technical schematic: 24.8 kWh battery system, dual thermal zones, integrated fleet monitoring
          </p>
        </div>
