  ...
  return (
    <div className="pt-20 md:pt-24 pb-8">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-16 md:mb-24">
        <a href="mailto:anolan22@gmail.com" className="group p-5 rounded-2xl bg-white dark:bg-[#141414] border border-[#eeebe5] dark:border-[#1e1c1a] hover:border-amber-600/20 dark:hover:border-amber-500/15 hover:-translate-y-1 transition-all">
        ...
        <a href="https://linkedin.com/in/andrewdavidnolan" target="_blank" rel="noopener noreferrer" className="group p-5 rounded-2xl bg-white dark:bg-[#141414] border border-[#eeebe5] dark:border-[#1e1c1a] hover:border-amber-600/20 dark:hover:border-amber-500/15 hover:-translate-y-1 transition-all">
        ...
        <a href="tel:+13153918464" className="group p-5 rounded-2xl bg-white dark:bg-[#141414] border border-[#eeebe5] dark:border-[#1e1c1a] hover:border-amber-600/20 dark:hover:border-amber-500/15 hover:-translate-y-1 transition-all">
          <svg className="w-5 h-5 text-amber-600 dark:text-amber-500 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section className="rounded-2xl bg-[#1a1a1a] dark:bg-[#141414] border border-[#252220] dark:border-[#1e1c1a] overflow-hidden">
        <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#2a2825]">
          <div className="p-8">
            ...
            <p className="text-sm leading-relaxed text-[#a8a29e]">Three acquisitions in 15 years. I build the operational infrastructure that makes companies transferable assets.</p>
          </div>
          <div className="p-8">
            <p className="font-['Syne'] font-bold text-sm text-amber-500 tracking-wide mb-3">HARDWARE + SOFTWARE</p>
            <p className="text-sm leading-relaxed text-[#a8a29e]">From custom IoT vehicles to React apps — I bridge the gap between physical operations and digital systems.</p>
          </div>
          <div className="p-8">
            <p className="font-['Syne'] font-bold text-sm text-amber-500 tracking-wide mb-3">AI TRANSFORMATION</p>
            <p className="text-sm leading-relaxed text-[#a8a29e]">Replaced a 150-person operation with autonomous agents. I don&apos;t just adopt AI — I architect it into the operating model.</p>
          </div>
        </div>
      </section>
    </div>
