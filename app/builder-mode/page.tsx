              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-neutral-100 dark:border-neutral-900">
                    ...
                    <td className="py-2 px-3 text-right text-emerald-600 dark:text-emerald-500 font-semibold">+95%</td>
                  </tr>
                  <tr>
                    <td className="py-2 px-3 text-neutral-700 dark:text-neutral-300">Silver</td>
                    <td className="py-2 px-3 text-right text-emerald-600 dark:text-emerald-500 font-semibold">+85%</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800">
            <h3 className="text-xl font-semibold mb-2">🥫 Pantry</h3>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 text-xs rounded bg-neutral-200 dark:bg-neutral-800">Python</span>
                <span className="px-2 py-1 text-xs rounded bg-neutral-200 dark:bg-neutral-800">Streamlit</span>
                <span className="px-2 py-1 text-xs rounded bg-neutral-200 dark:bg-neutral-800">PostgreSQL</span>
                <span className="px-2 py-1 text-xs rounded bg-neutral-200 dark:bg-neutral-800">Ollama</span>
                <span className="px-2 py-1 text-xs rounded bg-neutral-200 dark:bg-neutral-800">BakLLaVA</span>
                <span className="px-2 py-1 text-xs rounded bg-neutral-200 dark:bg-neutral-800">Playwright</span>
              </div>
            </div>
